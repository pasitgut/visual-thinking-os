(() => {
  ...
  async function m(e, t, a, s) {
    ...
    for (const i of await e.keys(t, n))
      if (r === d(i.url, a)) return e.match(i, s);
  }
  var f = class {
    promise;
    resolve;
  ...
  function R(e) {
    ...
    return t !== e && (x.set(e, t), v.set(t, e)), t;
  }
  const q = (e) => v.get(e);
  function S(
    e,
  ...
  var K = class {
      ...
      async getFirstEntryId() {
        return (await (await this.getDb()).transaction(O).store.openCursor())
          ?.value.id;
      }
      async getAllEntriesByQueueName(e) {
        return (
          (await (
            await this.getDb()
          ).getAllFromIndex(O, B, IDBKeyRange.only(e))) || []
        );
      }
  ...
  var $ = class e {
    ...
    static async fromRequest(t) {
      const a = { url: t.url, headers: {} };
      for (const e of ("GET" !== t.method &&
  ...
  var Y = class {
      ...
      async cachePut(e, t) {
        ...
        try {
          ...
          if (e instanceof Error)
            throw ("QuotaExceededError" === e.name && (await g()), e);
        }
    ...
    ee = class extends Z {
      ...
      async _getNetworkPromise({
        ...
        return (
          e && clearTimeout(e), (r || !n) && (n = await s.cacheMatch(t)), n
        );
      }
    },
    et = class extends Z {
  ...
  var ed = class {
    ...
    ef = class {
      ...
      _getCacheExpiration(e) {
        ...
        return (
          t ||
            ((t = new em(e, this._config)), this._cacheExpirations.set(e, t)),
          t
        );
      }
  ...
  const eg = /^\/(\w+\/)?collect/,
    ew = ({ serwist: e, cacheName: t, ...a }) => {
      ...
      for (const t of [
        ...
        new es(
          (s = ({ url: e }) =>
            "www.google-analytics.com" === e.hostname && eg.test(e.pathname)),
          (r = new et({ plugins: [o] })),
          "GET",
        ),
        new es(s, r, "POST"),
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
  ...
  new eR({
    precacheEntries: [
      { revision: null, url: "/_next/static/chunks/342.3ac3668849edcb3c.js" },
      { revision: null, url: "/_next/static/chunks/454-f83ba622cbc3b6f7.js" },
      {
        revision: null,
        url: "/_next/static/chunks/4bd1b696-c01e857a205263b5.js",
      },
      { revision: null, url: "/_next/static/chunks/574-5fee115455fb9091.js" },
      {
        revision: null,
        url: "/_next/static/chunks/64ccbbeb-5d5c22b38c413e9f.js",
      },
      { revision: null, url: "/_next/static/chunks/901-644b07210545cf3a.js" },
      { revision: null, url: "/_next/static/chunks/971.941448c68a942b40.js" },
      {
        revision: null,
        url: "/_next/static/chunks/ad9b3e9a-663d81965814f27c.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/_global-error/page-13081aa0094116f6.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/_not-found/page-7a91f9e2213e676c.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/layout-95481ad3626232a5.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/manifest.webmanifest/route-13081aa0094116f6.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/page-a225aa25faa01668.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/~offline/page-cb72988169d4100b.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/c37d3baf-2bdc6844e8465b2e.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/framework-b29f9083d3cda3b2.js",
      },
      { revision: null, url: "/_next/static/chunks/main-72aac6068aa791e0.js" },
      {
        revision: null,
        url: "/_next/static/chunks/main-app-f9e19d094a4ff047.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/app-error-13081aa0094116f6.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/forbidden-13081aa0094116f6.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/global-error-2503118f7cc024cd.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/not-found-13081aa0094116f6.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/unauthorized-13081aa0094116f6.js",
      },
      {
      ...
      {
        revision: null,
        url: "/_next/static/chunks/webpack-d9e024f84a442b6e.js",
      },
      { revision: null, url: "/_next/static/css/2ff2fe82741542a6.css" },
      { revision: null, url: "/_next/static/css/886f7af331f6427c.css" },
      { revision: null, url: "/_next/static/css/94b1db919656c647.css" },
      {
      ...
      {
        revision: "ff98c0dfbbd7c7703d5b8042ac791ebf",
        url: "/_next/static/q7JPzaPB5V_XZdUd2XZr6/_buildManifest.js",
      },
      {
        revision: "b6652df95db52feb4daf4eca35380933",
        url: "/_next/static/q7JPzaPB5V_XZdUd2XZr6/_ssgManifest.js",
      },
    ...
    runtimeCaching: [
      ...
      },
      {
        ...
        handler: new ex({ cacheName: "static-assets" }),
      },
      {
        matcher: ({ request: e }) =>
          "image" === e.destination || "font" === e.destination,
        handler: new ex({ cacheName: "media-assets" }),
      },
      {
        matcher: ({ url: e }) =>
          e.hostname.includes("firebase") ||
          e.hostname.includes("googleapis") ||
          e.hostname.includes("firebaseapp") ||
          e.pathname.includes("/__/"),
        handler: new et(),
      },
      ...eq,
    ],
    fallbacks: {
      entries: [
        {
          url: "/~offline",
          matcher: ({ request: e }) => "document" === e.destination,
        },
      ],
    },
  }).addEventListeners();
